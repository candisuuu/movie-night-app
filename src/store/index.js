...
import { userReducer, setUserData, setUserUpvotedMovie } from "./slices/userSlice";
...
export { store, setUserData, setUserUpvotedMovie, toggleModal, setDebouncedSearchTerm, setInstantSearchTerm, setSearchResultsPage, setSortBy, setSortOrder };
